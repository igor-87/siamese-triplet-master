...
from datasets import BalancedBatchSamplerOld, CustomDataset
...
train_batch_sampler = BalancedBatchSamplerOld(train_dataset, n_classes=10, n_samples=25)
test_batch_sampler = BalancedBatchSamplerOld(test_dataset, n_classes=10, n_samples=25)
...
model = embedding_net
# model = incept.inception_v3(True)
if cuda:
    model.cuda()
